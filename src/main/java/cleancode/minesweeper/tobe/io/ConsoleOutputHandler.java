...
public class ConsoleOutputHandler implements OutputHandler{
    ...
    private static final CellSignFinder CELL_SIGN_FINDER = new CellSignFinder();
...
//                String cellSign = CELL_SIGN_FINDER.findCellSignFrom(snapshot);
    ...
    public void showGameWinningComment() {
        System.out.println("지뢰를 찾았습니다. GAME CLEAR!");
    }
    ...
    @Override
    public void showCustomExceptionMessage(GameException e) {
        System.out.println(e.getMessage());
    }

    @Override
    public void showCommentForUserActionInput() {
        System.out.println("선택한 셀에 대한 행위를 선택하세요. (1: 오픈, 2: 깃발 꽂기)");
    }

    @Override
    public void showCommentForCellInput() {
