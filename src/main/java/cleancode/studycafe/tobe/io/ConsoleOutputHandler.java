...
public class ConsoleOutputHandler implements OutputHandler{
    ...
    public void showPassListForSelection(List<Pass> passes) {
        System.out.println();
    ...
    public void showLockerPass(StudyCafeLockerPass lockerPass) {
        System.out.println();
    ...
    public void showPassOrderSummary(StudyCafePass selectedPass, StudyCafeLockerPass lockerPass) {
        ...
        display(selectedPass);
        if (lockerPass != null) {
            System.out.println("사물함: ");
            display(lockerPass);
        }
    ...
    public void display(Pass pass) {
        if (pass.getPassType() == StudyCafePassType.HOURLY) {
            System.out.print(String.format("%s시간권 - %d원", pass.getDuration(), pass.getPrice())); ;
        }
        if (pass.getPassType() == StudyCafePassType.WEEKLY) {
            System.out.print(String.format("%s주권 - %d원", pass.getDuration(), pass.getPrice())); ;
        }
